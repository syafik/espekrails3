...
class TimetablesController < ApplicationController
  ...
  def create
    ...
    if @timetable.save
      ...
      params[:timetable][:trainer_ids].each_with_index do |tr, index|
        TimetablesTrainer.create(timetable: @timetable, trainer: Trainer.find(tr), category: params[:ttable][:categories]["#{params[:category][:index][index]}"])
